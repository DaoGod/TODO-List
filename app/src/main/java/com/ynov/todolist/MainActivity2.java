...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /** Retourner à la première Activity */
        ...
        /** cliquer sur le bouton pour la firebase */
    ...
    /** Ajouter une valeur dans la firebase*/
    public void addList(View view){
        ...
        if(!(itemsText.equals(""))){
            ...
            Toast.makeText(getApplicationContext(),"Ajout compléter", Toast.LENGTH_LONG).show();
